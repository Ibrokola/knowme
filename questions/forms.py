...
class UserResponseForm(forms.Form):
	...
	def clean_question_id(self):
		...
		try:
			...
			raise forms.ValidationError('There was an error with this question. Kindly try again')
		return question_id
	...
	def clean_answer_id(self):
		...
		try:
			...
			raise forms.ValidationError('There was an error with this answer. Kindly try again')
		return answer_id
